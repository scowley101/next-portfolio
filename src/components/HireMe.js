...
const HireMe = () => (
  <div className="fixed z-20 flex items-center justify-center overflow-hidden left-4 bottom-4 md:right-8 md:left-auto md:top-0 md:bottom-auto md:absolute sm:right-0">
...
dark:bg-primary dark:text-dark hover:dark:bg-dark hover:dark:text-light
