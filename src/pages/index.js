        ...
        <Layout className="pt-0 md:pt-16 sm:pt-16">
          <div className="flex items-center justify-between w-full lg:flex-col">
            <div className="w-1/2 md:w-full">
              <Image
                src={profilePic}
                alt="An image created with Midjourney AI. Prompt: a flat vector logo of a 90s computer with neon flames exploding from the screen in a vaporwave style"
            ...
            <div className="flex flex-col items-center self-center w-1/2 lg:w-full lg:text-center">
              <AnimatedText
                text="Designing digital solutions for practical challenges"
                className="!text-6xl !text-left 
                xl:!text-5xl lg:!text-center lg:!text=6xl md:!text-5xl sm:!text-3xl
                "
              />
              <p className="my-4 text-base font-medium md:text-sm sm:text-xs">
                A motivated and flexible front end developer eager to learn new
                skills and technologies. Driven by a desire to impact real world
                change through development. Explore my latest projects,
                showcasing my experience in a wide range of web technologies.
              </p>
              <div className="flex items-center self-start mt-2 lg:self-center">
                <Link
                  href="/sam-fearon_cv.pdf"
                  target="_blank"
