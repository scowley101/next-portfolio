...
const Article = ({ img, title, date, link }) => {
  return (
    <motion.li
      ...
      viewport={{ once: true }}
      className="relative flex items-center justify-between w-full p-4 py-6 my-2 border border-b-4 border-r-4 border-solid rounded-xl bg-light text-dark first:mt-0 border-dark dark:border-light dark:bg-dark dark:text-light sm:flex-col "
    >
